...
namespace SSS_Prac_Launcher
{
    ...
    class Prac_Hotkey
    {
        ...
        public static void Init()
        {
            ...
            hotkeys.Add(new Prac_Hotkey(SlimDX.DirectInput.Key.F1,Keys.F1, "F1", "invincable", (bool s) => { OverLayPatches.is_invincable = s; }, Color.White));
            hotkeys.Add(new Prac_Hotkey(SlimDX.DirectInput.Key.F2,Keys.F2, "F2", "disable pause", (bool s) => { OverLayPatches.is_disable_pause = s; }, Color.White));
